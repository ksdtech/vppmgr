(function($) {
	...
	$.fn.twosidedmultiselect = function() {
		...
		return this.each(function() {
			...
			"<p class=\"AddOne\" rel=\"" + newName + "\" title=\"Add Selected\">Add &rsaquo;</p>" +
			"<p class=\"AddAll\" rel=\"" + newName + "\" title=\"Add All\">Add All &raquo;</p>" +
			"<p class=\"RemoveOne\" rel=\"" + newName + "\" title=\"Remove Selected\">&lsaquo; Remove</p>" +
			"<p class=\"RemoveAll\" rel=\"" + newName + "\" title=\"Remove All\">&laquo; Remove All</p>" +
			"</div>" +
